...
Q_CONSTINIT static const qt_meta_stringdata_CLASSQtimerENDCLASS_t qt_meta_stringdata_CLASSQtimerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 15),  // "sendTimerUpdate"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 13)   // "handleTimeOut"
    },
    "Qtimer",
    "sendTimerUpdate",
    "",
...
void Qtimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Qtimer::sendTimerUpdate; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
